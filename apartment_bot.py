...
from core.normalize import (
    ...
    _CORNER_DISPLAY_RE, _CORNER_SLASH_RE, _TRAILING_NUMBER_RE, _extract_city_and_core,
    _format_core_with_city, _extract_candidate_cities, _infer_post_date,
    _is_recent_post_date, _post_date_sort_key, _CITY_ONLY_ADDRESSES,
    _classify_address_confidence,
)
