...
- "address" (String): רחוב, מספר ועיר. **חובה מוחלטת: המחרוזת חייבת להכיל אך ורק אותיות עבריות — אסור בהחלט שיופיעו בה אותיות לטיניות (A-Z/a-z), אפילו לא כתעתיק לפני או אחרי הכתיב העברי.** העתק את שם הרחוב בדיוק כפי שהוא כתוב בעברית בטקסט המקורי — אל תתרגם, אל תתעתק, ואל תוסיף גרסה אנגלית "בשביל בהירות". דוגמה שגויה: "etur habrisot רחוב טור הברושים" (אסור). דוגמה נכונה: "רחוב טור הברושים 5". הסר סופרלטיבים רגשיים ("השקט", "המבוקש"). אם עיר לא מוזכרת כלל בטקסט, הנח שהיא "רמת גן / גבעתיים".
