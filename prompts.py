...
- "address" (String): שם הרחוב ומספר בית בלבד, בדיוק כפי שכתוב בעברית בטקסט המקורי — לא כתובת מומצאת. **חובה מוחלטת: המחרוזת חייבת להכיל אך ורק אותיות עבריות — אסור בהחלט שיופיעו בה אותיות לטיניות (A-Z/a-z), אפילו לא כתעתיק לפני או אחרי הכתיב העברי.** אל תתרגם, אל תתעתק, ואל תוסיף גרסה אנגלית "בשביל בהירות". דוגמה שגויה: "etur habrisot רחוב טור הברושים" (אסור). דוגמה נכונה: "רחוב טור הברושים 5". הסר לחלוטין תארים ותוספות תיאוריות שאינן חלק משם הרחוב עצמו (למשל "השקט", "המבוקש", "הנחשק", "היוקרתי") — השאר רק את שם הרחוב הגולמי. אל תפרש צירופי סלנג כמו "שירוקלחת" (=שירותים+מקלחת) כשם רחוב. **אם שם רחוב מפורש אינו מופיע בבירור בטקסט — החזר null. לעולם אל תמציא או תנחש כתובת** (למשל אל תמציא "נמל התעופה" רק כי הפוסט מזכיר קרבה לאזור מסוים). אם עיר לא מוזכרת כלל בטקסט, הנח שהיא "רמת גן / גבעתיים" בלבד — בלי להמציא רחוב.
